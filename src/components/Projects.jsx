...
const ProjectCard = ({project, index}) => {
  return <motion.div className="flex w-full cursor-pointer md:w-[450px] h-[375px] bg-secondary rounded-md p-4 flex-col items-center justify-center gap-4" key={index}>
    <div className="bg-primary w-full h-full rounded-md overflow-hidden"
            ...
            <iframe
              ...
              style={{border:"none", width:"110%", height:"100%", overflow:"auto"}}
            />  
            </div>
