...
// to check if the user is unthenticated to use the home option/component  protected-routing
  ...
  return (
    ...
    <div className={`w-2 ${
      isSideMenu ? "w-2" : "flex-[.2] xl:flex-[.2]" } min-h-screen max-h-screen relative bg-secondary px-3 py-6 flex flex-col items-center justify-start gap-4 transition-all duration-200 ease-in-out`}>
        ...
        <div className='overflow-hidden w-full flex flex-col gap-4'>
          {/* logo  */}
          <Link to={"/home"}>
          <img src={Logo} alt="logo" className='object-contain w-72 h-auto' /></Link> 
